...
const Hospital = () => {
    ...
    const handleSubmitPatient = async (e) => {
        ...
        try {
            ...
            await contract.methods.addNewPatient(patientAdd.id, patientAdd.name, patientAdd.gender, patientAdd.bloodgroup, patientAdd.dob, patientAdd.number, patientAdd.address, result, patientAdd.ethAdd.trim()).send({ from: accounts[0] });
